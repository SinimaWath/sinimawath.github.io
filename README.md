...
### Курс "JavaScript/​DOM/​Интерфейсы" для новичков на learn.javascript.ru
https://learn.javascript.ru/courses/jsbasic
Помогаю новичкам полюбить Фронтенд ❤

Полностью веду курс, как один из преподавателей:
- Читаю лекции.
- Проверяю домашнии задания.
- Даю обратную связь.
...
### Ментор по фронтенду в Технопарке(2019-2020).
Чем я занимаюсь как ментор?
